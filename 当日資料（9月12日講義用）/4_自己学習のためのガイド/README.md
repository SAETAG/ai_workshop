...
プロンプト作成がめんどくさい方は、別リポジトリでご用意した **[プロンプトインタプリター](https://github.com/dmasubuchi/PromptInterpreter)** をコピペして使ってください。

**何ができるの？**
- 🤖 あなたの曖昧な相談を自動で診断・整理
- 💡 不足情報を自動で補完（仮置きで提案）
- 📝 他のAIにそのまま渡せる「骨子」と「詳細」の2層構造で出力
- 統合サマリー機能で複数資料も一発整理

**使い方は超簡単：**
1. GitHubから[`MyGPT-instruct-JP.md`](https://github.com/dmasubuchi/PromptInterpreter/blob/main/MyGPT-instruct-JP.md)をコピー
2. ChatGPTに貼り付け
3. あなたの相談や資料を投げるだけ

**結果：** 誰でも短時間で**正確で再現性のある指示プロンプト**が作れます。「AIを導入したのに逆に時間がかかる」という悩みから解放されます！
